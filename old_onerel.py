#!/usr/bin/env python3
"""
`old_onerel.py` is made obsolete; The functionality is integrated into `old_magphot.py, by Jan 30, 2025
A new `onerel.py` is created on Feb 18, 2025 from `old_magphot.py`
